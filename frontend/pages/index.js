            ...
            <div className="content">
                ...
                <div className="details">
                    ...
                    <div className="box">
                        ...
                        <p className="main-text"><div style={{ fontWeight: 'bold', color: "black" }}>Preorder your 2022 UMass yearbook at the discounted price of $20 for a limited time!</div>
                        ...
                        <Button type="submit" href="https://www.umass.edu/sga/index_preorder/" className="button" variant="secondary" style={{color: "white"}}>Add to Cart</Button>
                    </div>
                </div>
            </div>
